...
const pipelines: NavSectionItems = {
  ...
  items: [
    {
      label: 'Github의 이해',
      href: '/dashboard/room/github/class1',
      icon: 'textSelect',
    },
    {
      label: 'Github 배포',
      href: '/dashboard/room/github/class2',
      icon: 'braces',
    },
    {
      label: 'DevOps',
      href: '/dashboard/room/github/class3',
      icon: 'checkCircle',
    },
  ],
};
...
const structuredData: NavSectionItems = {
  ...
  items: [
    {
      label: 'AWS 알아보기',
      href: '/dashboard/room/aws/class1',
      icon: 'textSelect',
    },
    {
      label: 'AWS 컴퓨팅',
      href: '/dashboard/room/aws/computing',
      icon: 'invoice',
    },
    {
      label: 'AWS 네트워킹',
      href: '/dashboard/room/aws/networking',
      icon: 'receipt',
    },
    {
      label: 'AWS 스토리지',
      href: '/dashboard/room/aws/storage',
      icon: 'creditCard',
    },
    {
      label: 'AWS 데이터베이스',
      href: '/dashboard/room/aws/database',
      icon: 'creditCard',
    },
    {
      label: 'AWS Lambda',
      href: '/dashboard/room/aws/lambda',
      icon: 'creditCard',
    },
  ],
};
